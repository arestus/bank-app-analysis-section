...
export class BarChart2Component implements OnInit {
  ...
  dataChart3 = [
    {
      "stats": "min",
      "value": min(this.save.newArray, (d:any) => Number(d.balance))
    },
    {
      "stats": "max",
      "value": max(this.save.newArray, (d:any) => Number(d.balance))
    },
    {
      "stats": "avg",
      "value": mean(this.save.newArray, (d:any) => Number(d.balance))
    }
  ]
