...
export class BarChart4Component implements OnInit {
  ...
  dataChart3 = [
    {
      "stats": "min",
      "value": min(this.save.newArray, (d:any) => Number(d.withdraw))
    },
    {
      "stats": "max",
      "value": max(this.save.newArray, (d:any) => Number(d.withdraw))
    },
    {
      "stats": "avg",
      "value": mean(this.save.newArray, (d:any) => Number(d.withdraw))
    }
  ]
